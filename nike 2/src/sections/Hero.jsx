...
const Hero = () => {
  return (
    <section id="home"
    className="w-full flex1:flex-row flex-col justify-center min-h-screen gap-10 max-container ">
    <div className="relative x1:w-2/5 flex flex-col justify-center items-start w-full max-x1:padding-x pt-28">
